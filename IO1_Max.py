...
x = numpy.arange(-1, 40, 4.1)
y = numpy.arange(-4, 50, 5.4)
...
i1 = (0,0)
i2 = Linea_1.intersection(Eje_y)
i3 = Linea_1.intersection(Linea_2)
i4 = Linea_2.intersection(Eje_x)
...
Vertices_x = [i1[0], i2.x, i3.x, i4.x]
Vertices_y = [i1[1], i2.y, i3.y, i4.y]

Max=Vertices_x[0]+Vertices_y[0]
aux=0;
for i in range(len(Vertices_x)-1):
  if Vertices_x[i+1]+Vertices_y[i+1]>Max:
    Max=Vertices_x[i+1]+Vertices_y[i+1]
    aux=i+1

#Imprimimos en la consola el resultado
print ("El valor maximo de p es: ", math.floor(Max), ", X es: ", math.floor(Vertices_x[aux]), "y Y es: ", math.floor(Vertices_x[aux]))
